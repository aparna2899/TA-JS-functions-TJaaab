...
function celsiusToFahrenheit(temperatureInCelcius) {
  temperatureInFahrenheit = temperatureInCelcius * 1.8 + 32;
  return `${temperatureInFahrenheit}°F is ${temperatureInCelcius}°C`
}
...
function sumOrProductOfN(n = 0,opereation) {
  if(opereation == 'sum')
    return n*(n+1)/2;
  else if(opereation == 'product'){
    let factorial = 1;
    for(i = 1; i <= n; i++)
